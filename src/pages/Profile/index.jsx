...
import { fetchOrUpdateById } from '../../features/profile'
...
function Profile() {
  ...
  const profileData = useSelector((state) => state.freelanceId)
  const { picture, name, location, tjm, job, skills, available, id } =
  profileData.data.freelanceData

  useEffect(() => fetchOrUpdateById(store, queryId), [store, queryId])
